@if(isset($ad))
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin_update_ad') }}" enctype="multipart/form-data">
            {{--    common--}}
            @csrf
            ...
            <script>        $("#specific").load( 'http://127.0.0.1:8000/admin_edit_specific_form?category_id={{ $ad->category_id  }}&ad_id={{ $ad->ad_id }}');
            </script>
            @if(isset($ad->images))
            ...
            <div class="form-group mt-3 mb-5">
                <button type="submit" value="submit" class="btn btn-primary flex col-12">Update My Ad</button>
            </div>
        </form>
    </div>
