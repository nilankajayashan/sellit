...
<script>
    ...
    $("#specific").load( 'http://127.0.0.1:8000/specific_form?name={{ Request::get('name') }}');
</script>
<script>
...
<form method="POST" action="{{ route('submit_post') }}" enctype="multipart/form-data">
{{--    common--}}
@csrf
...
{{--    specific--}}
    ...
    @if(!session()->has('user_token'))
        <div class="alert alert-primary mt-3" role="alert">Your Information</div>
        <div class="row">
            <div class="col-lg-4">
                <label for="guest_first_name">Your First Name</label>
                <input type="text" class="form-control" id="guest_first_name" name="guest_first_name">
            </div>
            <div class="col-lg-4">
                <label for="guest_last_name">Your Last Name</label>
                <input type="text" class="form-control" id="guest_last_name" name="guest_last_name">
            </div>
            <div class="col-lg-4">
                <label for="guest_email">Your E-mail Address</label>
                <input type="text" class="form-control" id="guest_email" name="guest_email">
            </div>
            <div class="col-lg-4">
                <label for="guest_phone">Your Mobile Number</label>
    ...
    <div class="form-group mt-3 mb-5">
        <button type="submit" value="submit" class="btn btn-blue flex col-12">PAY and POST AD</button>
    </div>
</form>
