...
<script defer>
    ...
    //check box
    let amenities=['Air Conditioned','Basement','Dining Room','Elevator','Fireplace','Furnished','Garage','Garden','Loft','New Construction','Parking','Playground','Pool','Security Features'];
