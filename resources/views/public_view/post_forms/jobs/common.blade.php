<div class="row">
    <div class="col-lg-4 mt-3" id="industry_box">
        ...
        <select class="form-select form-select-md mb-3 " aria-label=".form-select-lg example" onchange="OptionBox('industry_box',value,'industry')" name="industry">
    ...
    <div class="col-lg-4 mt-3" id="job_type_box">
        ...
        <select class="form-select form-select-md mb-3 " aria-label=".form-select-lg example" onchange="OptionBox('job_type_box',value,'job_type')" name="job_type">
    ...
    <div class="col-lg-4 mt-3" id="work_experience_box">
        ...
        <select class="form-select form-select-md mb-3 " aria-label=".form-select-lg example" onchange="OptionBox('work_experience_box',value,'work_experience')" name="work_experience">
